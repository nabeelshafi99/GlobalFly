      ...
      <div className="form-box">
        ...
        <div className={`alert-box ${alert ? "block" : "hidden" }`}>
          ...
          <div className="form-field">
            <span>Email</span>
            <input type="email" onChange={(e) => setEmail(e.target.value)} value={email} placeholder="email@gmail.com" />
          </div>
          <div className="form-field">
            <span>Password</span>
        ...
        <div className="auth-btn-section">
          <button onClick={handleLogin} disabled={checkField} style={checkField ? {opacity:0.7} : {opacity:1}}>Login</button>
          <div>
            Don't have an account?
            <Link className="ms-2" to={"/auth/register"}>Signup</Link>
          </div>
        </div>
